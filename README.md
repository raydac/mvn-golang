...
- __Added `mvninstall` goal which processes the `install` goal and creates project artefact in local maven repository,[#2 request](https://github.com/raydac/mvn-golang/issues/2)__
